...
cup_models = {cup_id: tm.load_mesh(os.path.join(base_path, 'data/cups/onepiece/%d.obj'%cup_id)) for cup_id in cup_id_list}
...
for i in cup_id_list:
    ...
    for j in range(1,11):
        mat_data = sio.loadmat(os.path.join(base_path, 'data/grasp/cup%d/cup%d_grasping_60s_%d.mat'%(i,i,j)))['glove_data']
