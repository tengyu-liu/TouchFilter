...
class HandModel:
    def __init__(self, batch_size):
        ...
        self.pts_feature = {p: tf.constant(np.load(os.path.join(os.path.dirname(__file__), '../data', p + '.sample_feat.npy')), dtype=tf.float32) for p in self.parts if '0' not in p}
