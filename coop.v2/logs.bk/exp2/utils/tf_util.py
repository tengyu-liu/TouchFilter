...
def bilinear(inputs, num_outputs, scope, num_hidden=512, is_training=None, weight_decay=0.0):
  with tf.variable_scope(scope) as sc:
    ...
    l2 = l1 + h1
    h2 = fully_connected(l2, num_hidden, scope='h3', bn=False, weight_decay=weight_decay)
    l3 = l2 + h2
...
def batch_norm_template(inputs, is_training, scope, moments_dims, bn_decay):
  ...
  with tf.variable_scope(scope) as sc:
    ...
    beta = _variable_on_cpu(name='beta', shape=[num_channels], initializer=tf.initializers.constant(0.0))
    gamma = _variable_on_cpu(name='gamma', shape=[num_channels], initializer=tf.initializers.constant(0.0))
